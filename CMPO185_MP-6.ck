...
(1000::ms, 200::ms, 1.0, 500::ms) => env.set; //setting the ADSR envelope

[56, 55, 56, 48] @=> int pitch1[]; //pitch array.

[0.4, 0.4, 0.4, 0.4] @=> float gain_array1[]; //gain array, includes 0 gain to incorporate rests between notes.


[2000::ms, 2000::ms, 2000::ms, 2000::ms] @=> dur beat_array1[]; //creating the beat array for note length
